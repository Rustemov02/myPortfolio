...
export default function Footer() {
  ...
  return (
    <Stack
      bgcolor="#4db5ff"
      gap={4}
      sx={{ paddingTop: "30px", paddingBottom: "130px" }}
      direction="column"
    ...
    >
      ...
      <Stack direction="row" justifyContent="center">
        <Button
          component="a"
          href="https://www.linkedin.com/in/bunyamin-rustamov-7a9359224/"
          target="_blank"
        >
        ...
        <Button component="a" href="https://t.me/rustemovb02" target="_blank">
      ...
      <Typography
        ...
        padding="0 5px"
      >
        2023 © Rustamov Dev Company.All rights reserved
      </Typography>
    </Stack>
  );
}
